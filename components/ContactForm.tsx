...
export default function ContactForm() {
  ...
  <div className="max-w-7xl mx-auto px-4">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">contact@harrytos.com</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h4 className="text-sm font-semibold text-slate-900 mb-1">Phone</h4>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h4 className="text-sm font-semibold text-slate-900 mb-1">Office</h4>
      ...
      <form onSubmit={handleSubmit} className="bg-slate-50 rounded-2xl p-8 lg:p-10">
        <div className="space-y-6">
          <div>
